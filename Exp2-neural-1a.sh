...
python parse.py --test_file $train_file1 --model_file $model_file --vocab_file $vocab_file --parsed_file ${train_file1}.parsed-tdt.$exp_id --classifier bi_lstm $labeled
...
python parse.py --test_file $train_file2 --model_file $model_file --vocab_file $vocab_file --parsed_file ${train_file2}.parsed-tdt.$exp_id --classifier bi_lstm $labeled
...
python parse.py --test_file $dev_file1 --model_file $model_file --vocab_file $vocab_file --parsed_file ${dev_file1}.parsed-tdt.$exp_id --classifier bi_lstm $labeled
...
python parse.py --test_file $dev_file2 --model_file $model_file --vocab_file $vocab_file --parsed_file ${dev_file2}.parsed-tdt.$exp_id --classifier bi_lstm $labeled
...
python parse.py --test_file $test_file1 --model_file $model_file --vocab_file $vocab_file --parsed_file ${test_file1}.parsed-tdt.$exp_id --classifier bi_lstm $labeled
...
python parse.py --test_file $test_file2 --model_file $model_file --vocab_file $vocab_file --parsed_file ${test_file2}.parsed-tdt.$exp_id --classifier bi_lstm $labeled
