...
def get_arg_parser():
    ...
    arg_parser.add_argument("--TE_label_set",
        help="which span label set to use: none, timex_event, or full",
    ...
    arg_parser.add_argument("--size_embed",
        help="word embedding size (bilstm model)", default=8)
    arg_parser.add_argument("--size_TE_label_embed",
        help="timex/event label embedding size (bilstm model)", default=4)
    arg_parser.add_argument("--size_lstm",
        help="single lstm vector size (bilstm model)", default=8)
    arg_parser.add_argument("--size_hidden",
        help="feed-forward neural network's hidden layer size (bilstm model)",
        default=8)
