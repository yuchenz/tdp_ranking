...
data_dir=../bert_preprocess/

train_file_stem=auto_data/all_news.train
dev_file_stem=auto_data/all_news.dev
test_file_stem=auto_data/all_news.test
...
model_file=models/${train_file_stem}.neural-BERT-model.$exp_id 
vocab_file=models/${train_file_stem}.neural-BERT-model.${exp_id}.vocab 
...
python parse.py --test_file $dev_file --model_file $model_file --vocab_file $vocab_file --parsed_file ${dev_file}.parsed-tdt.$exp_id --classifier bi_lstm $labeled
...
python parse.py --test_file $test_file --model_file $model_file --vocab_file $vocab_file --parsed_file ${test_file}.parsed-tdt.$exp_id --classifier bi_lstm $labeled
