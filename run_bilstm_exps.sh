...
echo eval dev data ...
python eval.py --gold_file $test_dev_file --parsed_file ${test_dev_file}.stage2-neural-parsed-$l.$exp_id $labeled 
...
echo eval test data ...
python eval.py --gold_file $test_test_file --parsed_file ${test_test_file}.stage2-neural-parsed-$l.$exp_id $labeled 
...
then
    ...
    python eval.py --gold_file $test_dev_file --parsed_file ${test_dev_file}.stage2-neural-parsed-$l.$exp_id
    echo unlabeled evaluations on test data ...
    python eval.py --gold_file $test_test_file --parsed_file ${test_test_file}.stage2-neural-parsed-$l.$exp_id
fi
